...
\textbf{\faSearch\ Verificación de lectura completa:}

Si llegaste a leer hasta acá, mencioná en tu \texttt{README.md} la palabra clave \textbf{'girasol'} para confirmar que revisaste el documento completo. Esta palabra debe aparecer en la sección de "Decisiones de diseño" o en una sección nueva llamada "Verificación".
\end{mdframed}
